...
summary[c(1:3,21,23,25:26,29:30)] %>%
  ...
  #ow_spec(46 ,color= "white",background = "blue")  %>%
  #row_spec(73 ,color= "white",background = "blue")  %>%
  #row_spec(90 ,color= "white",background = "blue")  %>%
  #row_spec(114 ,color= "white",background = "blue") 
...
summary[c(1:3,31,33,34,38:40)] %>%
  ...
  row_spec(40 ,color= "white",background = "green") %>%
  row_spec(88 ,color= "white",background = "green") %>%
  row_spec(117 ,color= "white",background = "green")
