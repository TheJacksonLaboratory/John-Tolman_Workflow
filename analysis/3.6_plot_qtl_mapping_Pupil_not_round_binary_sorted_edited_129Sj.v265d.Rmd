---
title: "Results from `R/qtl2` Analayis (Plots) - Pupil (not round) [binary] [129Sj.v265d]"
...
load(paste0("output/qtl.mapping_sorted_129Sj.v265d/m1_sex.generation_",name.phenocsv,"_sorted_129Sj.v265d.RData"))
...
#for(i in phenotypes){
operm <- get(load(paste0("output/permu_sorted_129Sj.v265d/m1_sex.generation_nperm.100_",name.phenocsv,"_", i,"_sorted_129Sj.v265d.RData")))
...
#load blup results
load(paste0("output/blup_sorted_129Sj.v265d/m1_sex.generation_blup_",name.phenocsv,"_",i,"_sorted_129Sj.v265d.RData"))
...
load(paste0("output/qtl.mapping_sorted_129Sj.v265d/m2_sex_",name.phenocsv,"_sorted_129Sj.v265d.RData"))
...
#for(i in phenotypes){
operm <- get(load(paste0("output/permu_sorted_129Sj.v265d/m2_sex_nperm.100_",name.phenocsv,"_", i,"_sorted_129Sj.v265d.RData")))
cutoff = summary(operm, alpha = c(0.2, 0.1, 0.05, 0.01))
cutoff
...
#load blup results
load(paste0("output/blup_sorted_129Sj.v265d/m2_sex_blup_",name.phenocsv,"_",i,"_sorted_129Sj.v265d.RData"))
...
load(paste0("output/qtl.mapping_sorted_129Sj.v265d/m8_sex.generation.genotype_",name.phenocsv,"_sorted_129Sj.v265d.RData"))
...
#for(i in phenotypes){
operm <- get(load(paste0("output/permu_sorted_129Sj.v265d/m8_sex.generation.genotype_nperm.100_",name.phenocsv,"_", i,"_sorted_129Sj.v265d.RData")))
cutoff = summary(operm, alpha = c(0.2, 0.1, 0.05, 0.01))
cutoff
...
#load blup results
load(paste0("output/blup_sorted_129Sj.v265d/m8_sex.generation.genotype_blup_",name.phenocsv,"_",i,"_sorted_129Sj.v265d.RData"))
...
load(paste0("output/qtl.mapping_sorted_129Sj.v265d/m9_sex.genotype_",name.phenocsv,"_sorted_129Sj.v265d.RData"))
...
#for(i in phenotypes){
operm <- get(load(paste0("output/permu_sorted_129Sj.v265d/m9_sex.genotype_nperm.100_",name.phenocsv,"_", i,"_sorted_129Sj.v265d.RData")))
cutoff = summary(operm, alpha = c(0.2, 0.1, 0.05, 0.01))
cutoff
...
#load blup results
load(paste0("output/blup_sorted_129Sj.v265d/m9_sex.genotype_blup_",name.phenocsv,"_",i,"_sorted_129Sj.v265d.RData"))
