...
summary[c(1:3,31,33,34,38:40)] %>%
  ...
  row_spec(26 ,color= "white",background = "green") %>%
  row_spec(33 ,color= "white",background = "green")%>%
  row_spec(34 ,color= "white",background = "green")%>%
  row_spec(47 ,color= "white",background = "green")%>%
  row_spec(52 ,color= "white",background = "green")%>%
  row_spec(54 ,color= "white",background = "green")%>%
  row_spec(103 ,color= "white",background = "green")%>%
  row_spec(113 ,color= "white",background = "green") %>%
  row_spec(130 ,color= "white",background = "green") %>%
  row_spec(183 ,color= "white",background = "green")
