...
summary[c(1:3,21,23,25:26,29:30)] %>%
  ...
  #row_spec(83 ,color= "white",background = "blue")  #%>%
...
summary[c(1:3,31,33,34,38:40)] %>%
  ...
  row_spec(6 ,color= "white",background = "green")  %>%
  row_spec(17 ,color= "white",background = "green")  %>%
  row_spec(39 ,color= "white",background = "green") %>%
  row_spec(53 ,color= "white",background = "green") %>%
  row_spec(55 ,color= "white",background = "green") %>%
  row_spec(113 ,color= "white",background = "green") %>%
  row_spec(114 ,color= "white",background = "green")
