---
title: "Step 1: Sample QC [all samples]"
...
filepaths = '/Users/corneb/Documents/MyJax/CS/Projects/Simon.John.Tolman/haplo.reconst/2020-11-23/all.samples/all_samples_sorted/'
...
#save into pdf
pdf(file = "output/Percent_missing_genotype_data_all.pdf", width = 20, height = 20)
...
save(percent_missing,file = "data/percent_missing_id_all.RData")
...
save(summary.cg,file = "data/summary.cg_all.RData")
...
project <- read.csv("/Users/corneb/Documents/MyJax/CS/Projects/Simon.John.Tolman/Data/meta.data/project_file.csv", as.is=T)
...
##str(pr)
#save(m, file = "data/m_all.RData")
#save(nxo, file = "data/nxo_all.RData")

#e <- calc_errorlod(gm, pr)
##str(e)
#e <- do.call("cbind", e)
#save(e, file = "data/e_all.RData")

##snpg <- predict_snpgeno(gm, m)
##snpg <- do.call("cbind", snpg)
##save(snpg, file = "data/snpg_all.RData")
...
#pdf(file = "output/number_crossover_all.pdf")
...
#                     axispos=list(xtitle=25, ytitle=50, xlabel=5, ylabel=5)))
#save(errors_ind, file = "data/errors_ind_all.RData")
...
#pdf(file = "output/Percent_genotype_errors_obs_vs_predicted_all.pdf",width = 20, height = 20) 
#par(pty="s")
#err_direct <- rowMeans(snpgn != gobs, na.rm=TRUE)*100
#errors_ind_0 <- rowSums(e > 0)[rownames(gm$covar)]/n_typed(gm)*100
#par(mar=c(4.1,4.1,0.6, 0.6))
...
bad.sample <- qc_info[qc_info$generation ==1 | qc_info$percent_missing >= 10 | qc_info$remove.id.duplicated == TRUE,]

save(qc_info, bad.sample, file = "data/qc_info_bad_sample_all.RData")
...
save(gm_samqc, file = "data/gm_samqc_all.RData")
...
#save(e,g,snpg, file = "data/e_g_snpg_samqc_all.RData")
#save(e,g, file = "data/e_g_snpg_samqc_all.RData")
save(g, file = "data/e_g_snpg_samqc_all.RData")
